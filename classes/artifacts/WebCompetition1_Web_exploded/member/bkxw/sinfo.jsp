...
%>       
    <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
      ...
      <td align="center" valign="middle" class="borderright borderbottom"><%=pagelist2.get(10).toString() %></td> 
      <td align="center" valign="middle" class="borderright borderbottom"><%=pagelist2.get(9).toString() %></td> 
      <td align="center" valign="middle" class="borderbottom"> 
      <a onFocus="this.blur()" class="add" href="<%=basePath%>member/bkxw/add.jsp?method=upbkxw&id=<%=pagelist2.get(0).toString()%>">修改</a>
       <a onFocus="this.blur()" class="add" href="<%=basePath%>ComServlet?method=delbkxw&id=<%=pagelist2.get(0).toString()%>" onclick="if (confirm('确定要删除吗？')) return true; else return false;"> 删除</a>
      </td>
    </tr> 
<% }} %>  
    </table>
