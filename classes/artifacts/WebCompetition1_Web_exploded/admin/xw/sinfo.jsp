...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    ...
    <tr>
      ...
      <th align="center" valign="middle" class="borderright">新闻标题</th>  
      <th align="center" valign="middle" class="borderright">作者</th>
      <th align="center" valign="middle" class="borderright">信息来源</th>  
...
<%  String word=Common.toChineseAndTrim(request.getParameter("word")); 
	...
	int cou = cb.getMessageCount("select count(*) from news where title like '%"+word+"%' ");//得到信息总数			        
	...
	List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from news where title like '%"+word+"%' order by nid desc",7);
...
%>       
    <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
      <td align="center" valign="middle" class="borderright borderbottom"><%=i+1 %></td><td align="center" valign="middle" class="borderright borderbottom">
      <a onFocus="this.blur()" href="<%=basePath%>xwinfo.jsp?id=<%=pagelist2.get(0).toString()%>" target="_blank"><%=pagelist2.get(5).toString() %></a></td> 
      ...
      <a onFocus="this.blur()" class="add" href="<%=basePath%>admin/xw/add.jsp?method=upxw&id=<%=pagelist2.get(0).toString()%>">修改</a>
       <a onFocus="this.blur()" class="add" href="<%=basePath%>ComServlet?method=delxw&id=<%=pagelist2.get(0).toString()%>" onclick="if (confirm('确定要删除吗？')) return true; else return false;"> 删除</a>
      </td>
    </tr> 
<% }} %>  
    </table>
