...
%>
  ...
  <div class="layui-col-md12">
    <div class="layui-panel">
      <div style="padding: 30px; height:150px;"><dt><img src="<%=basePath+pic %>" width="140" height="140" /></dt>
    <dd>
     <h3>用户：<%=pagelist2.get(1).toString() %></h3>
     <h4><%=pagelist2.get(2).toString() %></h4>
     <h5>时间：<span><%=pagelist2.get(3).toString().substring(0,pagelist2.get(3).toString().length()-5) %></span></h5>
     <div class="tishi">
...
<input type="hidden" name="page" value="<%=session.getAttribute("busPage").toString()%>" /><!--//用于给上面javascript传值-->         
	...
	<div align="center">
<%String member2=(String)session.getAttribute("user"); if(member2==null){ %>
<br> 
留言请登录！ 
<br>
<%}else{ %> 
