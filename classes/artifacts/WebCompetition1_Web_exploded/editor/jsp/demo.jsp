...
.main-for input.text-but{ width:100px; height:40px; line-height:30px; border: 1px solid #cdcdcd; background:#e6e6e6; font-family:"Microsoft YaHei","Tahoma","Arial",'宋体'; color:#969696; 
...
%>
	<form name="example" method="post" action="<%=basePath %>ComServlet">
		<textarea name="content1" cols="200" rows="700" class="text" style="width:860px;height:255px;visibility:hidden;"><%=htmlspecialchars(htmlData)%></textarea>
		<br />
