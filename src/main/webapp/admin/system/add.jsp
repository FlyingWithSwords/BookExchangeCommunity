...
String message = (String)request.getAttribute("message");
	...
	if(username==null){
		...
		String id="";
		String user="";String password="";String time="",owner="",address="";String sex="";String age="";String tel="";
		if(method.equals("upm")){
			id=request.getParameter("id");
			List alist=cb.get1Com("select * from user where id='"+id+"'",10);
			user=alist.get(1).toString();
			password=alist.get(2).toString();
			time=alist.get(3).toString();
			owner=alist.get(4).toString();
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                    <tr onMouseOut="this.style.backgroundColor='#ffffff'"
                        ...
                        <td align="left" valign="middle" class="borderright borderbottom main-for">
                            <%if (method.equals("upm")) { %><input type="text" name="username" class="text-word"
                                                                   value="<%=user %>" readonly/><%} else { %>
                    ...
                    <tr onMouseOut="this.style.backgroundColor='#ffffff'"
                        onMouseOver="this.style.backgroundColor='#edf5ff'">
                        <td align="right" valign="middle" class="borderright borderbottom bggray">用户年龄：</td>
                        <td align="left" valign="middle" class="borderright borderbottom main-for">
                            <input type="number" class="text-word" name="age" value="<%=age %>" min="18" max="100"
                                   required/>
                        </td>
                    </tr>
                    <tr onMouseOut="this.style.backgroundColor='#ffffff'"
                        ...
                        <td align="left" valign="middle" class="borderright borderbottom main-for">
                            <input type="text" class="text-word" name="tel" value="<%=tel %>" pattern="[0-9]{11}"
                                   title="11位手机号码" required/>
                        </td>
                    </tr>
                    <tr onMouseOut="this.style.backgroundColor='#ffffff'"
                        onMouseOver="this.style.backgroundColor='#edf5ff'">
                        <td align="right" valign="middle" class="borderright borderbottom bggray">联系地址：</td>
                        <td align="left" valign="middle" class="borderright borderbottom main-for">
