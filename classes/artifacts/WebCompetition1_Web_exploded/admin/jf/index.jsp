...
<%
	...
	List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from jifen order by id desc",4);
...
%>   
    <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
      ...
      <a onFocus="this.blur()" class="add" href="<%=basePath%>admin/jf/add.jsp?method=addjf&id=<%=pagelist2.get(0).toString()%>">修改</a>
       <a onFocus="this.blur()" class="add" href="<%=basePath%>ComServlet?method=deljf2&id=<%=pagelist2.get(0).toString()%>" onclick="if (confirm('确定要删除吗？')) return true; else return false;"> 删除</a>
      </td>
    </tr> 
<% }} %>  
	</table>
