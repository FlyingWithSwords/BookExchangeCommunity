                    ...
                    <div style="padding: 30px; height:250px;">
                        <dd>
                            <h3 style="word-break:break-all; white-space:nowrap; text-overflow:ellipsis; overflow:hidden;">
                                <a href="<%=basePath %>bkxwinfo.jsp?id=<%=pagelist2.get(0).toString()%>"><%=pagelist2.get(6).toString()%>
                                </a></h3>
                            ...
                            <h5>作者：<%=pagelist2.get(4).toString()%>
                            </h5>
                            <h5>信息来源：<%=pagelist2.get(3).toString()%>
                            </h5>
                            <h5>
                                发布时间：<%=pagelist2.get(5).toString().substring(0, pagelist2.get(5).toString().length() - 5)%>
                            </h5>
                            <h5>支付方式：<%=pagelist2.get(10).toString()%>
                            </h5><br/>
                            <font style="clear:both;margin-left:105%;color:red;font-size:22px;">￥<%=pagelist2.get(8).toString()%>
                            </font>
                            <font style="color:#909090;"><%=pagelist2.get(9).toString()%>
                            </font>
                            <div class="sellmails">
