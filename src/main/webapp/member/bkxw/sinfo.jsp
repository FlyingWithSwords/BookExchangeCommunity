...
<script language="javascript">
    function top2() {
        form3.action = "<%=basePath%>member/bkxw/sinfo.jsp?page=1";
        form3.submit();
    }
    ...
    function last2() {
        if (form3.pageCount.value == 0) {//如果总页数为0，那么最后一页为1，也就是第一页，而不是第0页
            ...
            form3.action = "<%=basePath%>member/bkxw/sinfo.jsp?page=" + form3.pageCount.value;
            form3.submit();
        }
    }
    ...
    function pre2() {
        ...
        if (page <= 1) {
            ...
            form3.action = "<%=basePath%>member/bkxw/sinfo.jsp?page=" + (page - 1);
            form3.submit();
        }
    }
    ...
    function bjump2() {
        ...
        if (form3.busjump.value > pageCount) {//如果跳转文本框中输入的页数超过最后一页的数，则跳到最后一页
            if (pageCount == 0) {
                ...
                form3.action = "<%=basePath%>member/bkxw/sinfo.jsp?page=" + pageCount;
                form3.submit();
            }
            ...
            if (page == 0) {
                ...
                form3.action = "<%=basePath%>member/bkxw/sinfo.jsp?page=" + page;
                form3.submit();
            } else {
                form3.action = "<%=basePath%>member/bkxw/sinfo.jsp?page=" + page;
                form3.submit();
    ...
    <table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
            ...
            <td align="left" valign="top">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                    <tr>
                        ...
                        <th align="center" valign="middle" class="borderright">发布人</th>
                        <th align="center" valign="middle" class="borderright">来源</th>
                        <th align="center" valign="middle" class="borderright">著书者</th>
                        <th align="center" valign="middle" class="borderright">时间</th>
                        <th align="center" valign="middle" class="borderright">价格</th>
                        <th align="center" valign="middle" class="borderright">购买者</th>
                    ...
                    <% String word = Common.toChineseAndTrim(request.getParameter("word"));
                        ...
                        int cou = cb.getMessageCount("select count(*) from housenews where writer='" + username + "' and title like '%" + word + "%' ");//得到信息总数
                        ...
                        List pagelist1 = cb.getMessage(Integer.parseInt(page1), "select * from housenews where writer='" + username + "' and title like '%" + word + "%' order by hnid desc", 12);
                    ...
                    <tr onMouseOut="this.style.backgroundColor='#ffffff'"
                        ...
                        <td align="center" valign="middle"
                            class="borderright borderbottom"><%=pagelist2.get(6).toString() %>
                        </td>
                        <td align="center" valign="middle"
                        ...
                        <td align="center" valign="middle"
                            class="borderright borderbottom"><%=pagelist2.get(4).toString() %>
                        </td>
                        <td align="center" valign="middle"
                            class="borderright borderbottom"><%=pagelist2.get(5).toString() %>
                        </td>
                        <td align="center" valign="middle"
                            class="borderright borderbottom"><%=pagelist2.get(8).toString() %>
                        </td>
                        <td align="center" valign="middle"
                            class="borderright borderbottom"><%=pagelist2.get(7).toString() %>
                        </td>
                        <td align="center" valign="middle"
                            class="borderright borderbottom"><%=pagelist2.get(10).toString() %>
                        </td>
                        <td align="center" valign="middle"
                            class="borderright borderbottom"><%=pagelist2.get(9).toString() %>
                        </td>
                        <td align="center" valign="middle" class="borderbottom">
                            <a onFocus="this.blur()" class="add"
                               href="<%=basePath%>member/bkxw/add.jsp?method=upbkxw&id=<%=pagelist2.get(0).toString()%>">修改</a>
                            <a onFocus="this.blur()" class="add"
                               href="<%=basePath%>ComServlet?method=delbkxw&id=<%=pagelist2.get(0).toString()%>"
        ...
        <tr>
            <td valign="top" class="fenye"><input type="hidden" name="word" value="<%=word%>"/>
                ...
                第&nbsp;<input name="busjump" type="text" size="5"/>&nbsp;页&nbsp; <a href="#" onClick="bjump2()"
                                                                                    onFocus="this.blur()">&nbsp;转到</a>
            </td>
        </tr>
    </table>
</form>
