    ...
    <div class="sells">
        ...
        <div class="layui-row layui-col-space15">
            <div class="layui-col-md12">
                <div class="layui-panel">
                    <div style="padding: 30px;"><h3><%=pagelist2.get(1).toString() %>
                    </h3>
      ...
      <%
          if (session.getAttribute("user") != null) {
              ...
              if (pagelist2.get(1).toString().equals(username)) {
      %>
      <a href="<%=basePath %>member/index.jsp"> <img src="images/jfstar.png" width="40px" height="40px"
                                                     style="margin-top:-60px;margin-right:-45px;"/></a> <%
                  }
              }
          %></strong></span>
                        </div>
