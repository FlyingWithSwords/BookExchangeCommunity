            ...
            <td align="left" valign="top">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                    ...
                    <% String word = Common.toChineseAndTrim(request.getParameter("word"));
                        ...
                        int cou = cb.getMessageCount("select count(*) from useradvise where username like '%" + word + "%' ");//得到信息总数
                        ...
                        List pagelist1 = cb.getMessage(Integer.parseInt(page1), "select * from useradvise where username like '%" + word + "%' order by id desc", 5);
                    ...
                    <tr onMouseOut="this.style.backgroundColor='#ffffff'"
                        ...
                        <td align="center" valign="middle" class="borderbottom">
                            <a onFocus="this.blur()" class="add"
                               href="<%=basePath%>admin/jy/add.jsp?method=upjy&id=<%=pagelist2.get(0).toString()%>">回复</a>
                            <a onFocus="this.blur()" class="add"
                               href="<%=basePath%>ComServlet?method=deljy&id=<%=pagelist2.get(0).toString()%>"
