            ...
            <td align="left" valign="top">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                    ...
                    <%
                        ...
                        int cou = cb.getMessageCount("select count(*) from usersell");//得到信息总数
                        ...
                        List pagelist1 = cb.getMessage(Integer.parseInt(page1), "select * from usersell where username='" + username + "' order by id desc", 5);
                    ...
                    <tr onMouseOut="this.style.backgroundColor='#ffffff'"
                        ...
                        <td align="center" valign="middle" class="borderbottom">
                            <a onFocus="this.blur()" class="add"
                               href="<%=basePath%>ComServlet?method=delbuy&id=<%=pagelist2.get(0).toString()%>&bnid=<%=pagelist2.get(2).toString() %>"
                               onclick="if (confirm('确定要删除吗？')) return true; else return false;"> 退购</a>
                        </td>
                    </tr>
                    <% }
                    } %>
