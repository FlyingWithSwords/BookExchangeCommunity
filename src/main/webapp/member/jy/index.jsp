...
<script language="javascript">
    function top2() {
        form3.action = "<%=basePath%>member/jy/index.jsp?page=1";
        form3.submit();
    }
    ...
    function last2() {
        if (form3.pageCount.value == 0) {//如果总页数为0，那么最后一页为1，也就是第一页，而不是第0页
            ...
            form3.action = "<%=basePath%>member/jy/index.jsp?page=" + form3.pageCount.value;
            form3.submit();
        }
    }
    ...
    function pre2() {
        ...
        if (page <= 1) {
            ...
            form3.action = "<%=basePath%>member/jy/index.jsp?page=" + (page - 1);
            form3.submit();
        }
    }
    ...
    function bjump2() {
        ...
        if (form3.busjump.value > pageCount) {//如果跳转文本框中输入的页数超过最后一页的数，则跳到最后一页
            if (pageCount == 0) {
                ...
                form3.action = "<%=basePath%>member/jy/index.jsp?page=" + pageCount;
                form3.submit();
            }
            ...
            if (page == 0) {
                ...
                form3.action = "<%=basePath%>member/jy/index.jsp?page=" + page;
                form3.submit();
            } else {
                form3.action = "<%=basePath%>member/jy/index.jsp?page=" + page;
                form3.submit();
            ...
            <td align="left" valign="top">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                    ...
                    <%
                        ...
                        int cou = cb.getMessageCount("select count(*) from useradvise where username='" + username + "'");//得到信息总数
                        ...
                        List pagelist1 = cb.getMessage(Integer.parseInt(page1), "select * from useradvise where username='" + username + "' order by id desc", 5);
                    ...
                    <tr onMouseOut="this.style.backgroundColor='#ffffff'"
                        ...
                        <td align="center" valign="middle" class="borderbottom">
                            <a onFocus="this.blur()" class="add"
                               href="<%=basePath%>member/jy/add.jsp?method=upjy&id=<%=pagelist2.get(0).toString()%>">修改</a>
                            <a onFocus="this.blur()" class="add"
                               href="<%=basePath%>ComServlet?method=deljy2&id=<%=pagelist2.get(0).toString()%>"
