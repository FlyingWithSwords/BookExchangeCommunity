...
%>       
    <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
      ...
      <a onFocus="this.blur()" class="add" href="<%=basePath%>member/dh/add.jsp?method=updh&id=<%=pagelist2.get(0).toString()%>">修改</a>
       <a onFocus="this.blur()" class="add" href="<%=basePath%>ComServlet?method=deldh&id=<%=pagelist2.get(0).toString()%>" onclick="if (confirm('确定要删除吗？')) return true; else return false;"> 删除</a>
      </td>
    </tr> 
<% }} %>  
    </table>
