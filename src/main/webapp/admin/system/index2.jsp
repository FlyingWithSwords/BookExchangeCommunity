...
String message = (String)request.getAttribute("message");
	...
	if(username==null){
		...
		String method="upm2";
		String id="";String sex="";String age="";String tel="";String address=""; 
		List alist=cb.get1Com("select * from user where username='"+username+"'",9); 
            ...
            <form class="form-x" action="<%=basePath %>AdminServlet?method=<%=method%>" method="post" name="form1">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                    ...
                    <tr onMouseOut="this.style.backgroundColor='#ffffff'"
                        ...
                        <td align="left" valign="middle" class="borderright borderbottom main-for">
                            <textarea class="text-word" name="address" style="height:100px;"
