...
<frameset rows="95,*,30" cols="*" frameborder="no" border="0" framespacing="0">
    <!--top样式-->
    <frame src="<%=basePath %>member/iframe/top.jsp" name="topframe" scrolling="no" noresize id="topframe"
           title="topframe"/>
    <!--contact样式-->
    <frameset id="attachucp" framespacing="0" border="0" frameborder="no" cols="194,12,*" rows="*">
        <frame scrolling="auto" noresize="" frameborder="no" name="leftFrame"
               src="<%=basePath %>member/iframe/left.jsp"></frame>
        <frame id="leftbar" scrolling="no" noresize="" name="switchFrame"
               src="<%=basePath %>member/iframe/swich.jsp"></frame>
        <frame scrolling="auto" noresize="" border="0" name="mainFrame"
               src="<%=basePath %>member/iframe/main.jsp"></frame>
    </frameset>
    <!--bottom样式-->
    <frame src="<%=basePath %>member/iframe/bottom.jsp" name="bottomFrame" scrolling="No" noresize="noresize"
