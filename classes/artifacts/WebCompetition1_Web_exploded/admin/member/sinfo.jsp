...
%>       
    <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
      ...
      <td align="center" valign="middle" class="borderright borderbottom"><img src="<%=basePath+(pagelist2.get(9)==null?"pic/nobody.jpg":pagelist2.get(9).toString()) %>" width="100" height="100" border="0" /></td> 
