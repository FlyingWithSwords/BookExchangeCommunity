            ...
            <td align="left" valign="top">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                    ...
                    <% String word = Common.toChineseAndTrim(request.getParameter("word"));
                        ...
                        int cou = cb.getMessageCount("select count(*) from user where username like '%" + word + "%' ");//得到信息总数
                        ...
                        List pagelist1 = cb.getMessage(Integer.parseInt(page1), "select * from user where username like '%" + word + "%' order by id desc", 10);
                    ...
                    <tr onMouseOut="this.style.backgroundColor='#ffffff'"
                        ...
                        <td align="center" valign="middle" class="borderright borderbottom"><img
                                src="<%=basePath+(pagelist2.get(9)==null?"pic/nobody.jpg":pagelist2.get(9).toString()) %>"
                                width="100" height="100" border="0"/></td>
                        <td align="center" valign="middle" class="borderbottom">
                            <a onFocus="this.blur()" class="add"
                               href="<%=basePath%>MemberServlet?method=delm&id=<%=pagelist2.get(0).toString()%>"
