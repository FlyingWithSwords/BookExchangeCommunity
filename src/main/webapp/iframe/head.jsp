...
<head>
    ...
    <style type="text/css">
        ...
        .search input[type=submit] {
            background: #ededed url(http://webdesignerwall.com/demo/expandable-search-form/images/search-icon.png) no-repeat 8px;
...
<div id="userWin" class="">
    <iframe src="<%=basePath%>login.jsp" id="iframe1" width="900px" height="600px"
            style="max-width:900px;max-height:600px;border-radius: 1em; border: 0; background: #0005;"></iframe>
    <div align="center" class="qx" onclick="qxiframe();"><img src="<%=basePath %>images/qx.png"
                                                              style="width: 36px; height: auto;"></div>
    <script type="text/javascript">
