            ...
            <td align="left" valign="top">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                    <tr>
                        ...
                        <th align="center" valign="middle" class="borderright">购买项目</th>
                        <th align="center" valign="middle" class="borderright">项目内容</th>
                    ...
                    <% String word = Common.toChineseAndTrim(request.getParameter("word"));
                        ...
                        int cou = cb.getMessageCount("select count(*) from usersell where username like '%" + word + "%' ");//得到信息总数
                        ...
                        List pagelist1 = cb.getMessage(Integer.parseInt(page1), "select * from usersell where username like '%" + word + "%' order by id desc", 5);
                        ...
                        if (!pagelist3.isEmpty()) {
                            for (int i = 0; i < pagelist3.size(); i++) {
                                ...
                                List pagelisttmp = cb.get1Com("select * from booknews where bnid='" + pagelist2.get(2).toString() + "'", 10);
                    %>
                    <tr onMouseOut="this.style.backgroundColor='#ffffff'"
                        ...
                        <td align="center" valign="middle"
                            class="borderright borderbottom"><%=pagelisttmp.get(6).toString() %>
                        </td>
                        <td align="center" valign="middle"
                            class="borderright borderbottom"><%=pagelisttmp.get(1).toString() %>
                        </td>
                        <td align="center" valign="middle"
                        ...
                        <td align="center" valign="middle"
                            class="borderright borderbottom"><%=pagelisttmp.get(9).toString() %>
                        </td>
                        <td align="center" valign="middle" class="borderbottom">
                            <a onFocus="this.blur()" class="add"
                               href="<%=basePath%>admin/buy/add.jsp?method=upbuy&id=<%=pagelist2.get(0).toString()%>">修改</a>
                            <a onFocus="this.blur()" class="add"
                               href="<%=basePath%>ComServlet?method=delbuy&id=<%=pagelist2.get(0).toString()%>"
