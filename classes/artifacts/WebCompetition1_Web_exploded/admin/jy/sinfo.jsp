...
%>       
    <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
      ...
      <a onFocus="this.blur()" class="add" href="<%=basePath%>admin/jy/add.jsp?method=upjy&id=<%=pagelist2.get(0).toString()%>">回复</a>
      <a onFocus="this.blur()" class="add" href="<%=basePath%>ComServlet?method=deljy&id=<%=pagelist2.get(0).toString()%>" onclick="if (confirm('确定要删除吗？')) return true; else return false;"> 删除</a>
      </td>
    </tr> 
<% }} %>  
    </table>
