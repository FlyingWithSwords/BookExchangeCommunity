                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                    ...
                    <tr onMouseOut="this.style.backgroundColor='#ffffff'"
                        ...
                        <td align="center" valign="middle" class="borderright borderbottom">
                            <a onFocus="this.blur()" href="<%=basePath%>xwinfo.jsp?id=<%=pagelist2.get(0).toString()%>"
                               target="_blank"><%=pagelist2.get(5).toString() %>
                            </a></td>
                        ...
                        <td align="center" valign="middle" class="borderbottom">
                            <a onFocus="this.blur()" class="add"
                               href="<%=basePath%>admin/xw/add.jsp?method=upxw&id=<%=pagelist2.get(0).toString()%>">修改</a>
                            <a onFocus="this.blur()" class="add"
                               href="<%=basePath%>ComServlet?method=delxw&id=<%=pagelist2.get(0).toString()%>"
