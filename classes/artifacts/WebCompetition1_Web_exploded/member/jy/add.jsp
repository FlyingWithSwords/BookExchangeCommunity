...
String message = (String)request.getAttribute("message");
	...
	if(username==null){
		...
		String readonly="";
		List alist=cb.get1Com("select * from useradvise where id='"+id+"'",5);
		String adminconStr=cb.getString("select admincon from useradvise where id='"+id+"'");
		String content=alist.get(2).toString();
		if(!adminconStr.equals("未回复")){readonly="readonly=readonly"; content+="\n---------管理员已回复，不可修改！---------";}
%>
<body>
  ...
  <tr>
    ...
    <input type="hidden" name="method" value="<%=method%>" /><input type="hidden" name="id" value="<%=id%>" />
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">建议内容：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for"> 
        <textarea name="admincon" <%=readonly %>" required><%=content %></textarea>       
        </td
      </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">&nbsp;</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input name="" type="submit" disabled="disabled" value="提交" class="text-but"></td>
      </tr>
    </table>
    </form>
    </td>
