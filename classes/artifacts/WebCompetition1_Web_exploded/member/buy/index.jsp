...
%>   
    <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
      ...
      <td align="center" valign="middle" class="borderright borderbottom"><%=pagelisttmp.get(6).toString() %></td>
      ...
      <td align="center" valign="middle" class="borderright borderbottom"><%=pagelisttmp.get(9).toString() %></td>  
      <td align="center" valign="middle" class="borderbottom">
       <a onFocus="this.blur()" class="add" href="<%=basePath%>ComServlet?method=delbuy&id=<%=pagelist2.get(0).toString()%>&bnid=<%=pagelist2.get(2).toString() %>" onclick="if (confirm('确定要删除吗？')) return true; else return false;"> 退购</a>
      </td>
    </tr> 
<% }} %>  
	</table>
