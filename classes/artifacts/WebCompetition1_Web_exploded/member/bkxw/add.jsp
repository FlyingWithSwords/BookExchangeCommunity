...
String message = (String)request.getAttribute("message");
	...
	if(username==null){
		...
		String id="";String newscont="",writer="",origin="",bkwriter="",time="",title="",booker="",price="",issaled="",saleway="",imgsrc=""; 
		if(method.equals("upbkxw")){
			id=request.getParameter("id");
			List alist=cb.get1Com("select * from booknews where bnid='"+id+"'",12);
			newscont=alist.get(1).toString();
  ...
  <tr>
    ...
    <input type="hidden" name="method" value="<%=method%>" /><input type="hidden" name="id" value="<%=id%>" />
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for"> 
        <input type="text" name="writer" class="text-word" readonly="readonly" value="<%=username %>" required/>
        </td>
        </tr>
        <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for"> 
        <textarea name="newscont" style="width:700px;height:400px;"><%=newscont %></textarea>     
        </td>
        </tr>
        <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
         <select name="saleway" required>
    		  <option value=<%=saleway %>><%=saleway %></option>
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
         <select name="issaled" required>
    		  <option value=<%=issaled %>><%=issaled %></option>
