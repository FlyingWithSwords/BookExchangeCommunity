            ...
            <td align="left" valign="top">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                    ...
                    <%
                        ...
                        int cou = cb.getMessageCount("select count(*) from user where owner='员工'");//得到信息总数
                        ...
                        List pagelist1 = cb.getMessage(Integer.parseInt(page1), "select * from user where owner='员工' order by id desc", 10);
