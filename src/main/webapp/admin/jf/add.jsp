                    ...
                    <tr onMouseOut="this.style.backgroundColor='#ffffff'"
                        ...
                        <td align="left" valign="middle" class="borderright borderbottom main-for">
                            <select name="username" required>
                                ...
                                <%
                                    List flist0 = cb.getCom("select * from jifen where id='" + id + "'", 4);
                                    if (!flist0.isEmpty()) {
                                        for (int i = 0; i < flist0.size(); i++) {
                                            List list20 = (List) flist0.get(i);
                                %>
                                <option value=<%=list20.get(1).toString() %>><%=list20.get(1).toString() %>
                                </option>
                                <%
                                        }
                                    }
                                ...
                                <%} %>
                                <%
                                    List flist = cb.getCom("select * from user where owner='用户' order by id desc", 4);
                                    if (!flist.isEmpty()) {
                                        for (int i = 0; i < flist.size(); i++) {
                                            List list2 = (List) flist.get(i);
                                %>
                                <option value=<%=list2.get(1).toString() %>><%=list2.get(1).toString() %>
                                </option>
                                <%
                                        }
                                    }
