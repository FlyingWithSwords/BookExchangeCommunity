...
<div class="bg">
    <center>
        <form name="form1" action="<%=basePath %>MemberServlet?method=mlogin" method="post" class="regForm">
            <p id="image_logo"><img src="<%=basePath %>admin/images/login/fly.png" weight="50px" height="50px"
            ...
            <div class="regSubs">
                <p><input type="submit" value="登录"/>&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="注册"
                                                                                   onclick="reg()"/></p>
                <div style="margin-top:20px;margin-right: 10%;font-family: 宋体;font-size:13px;text-align: right;"><a
                        onclick="admin()">内部登录</a>&nbsp;&nbsp;&nbsp;<a onclick="lost()">忘记密码？</a></div>
            </div>
        </form>
    </center>
</div>
