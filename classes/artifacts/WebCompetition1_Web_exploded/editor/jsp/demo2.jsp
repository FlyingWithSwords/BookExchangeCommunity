...
%>
	<form name="example" method="post" action="demo2.jsp?sub=enter&caller=<%=caller %>">
		<textarea name="content1" cols="200" rows="700" class="text" style="width:860px;height:210px;visibility:hidden;"><%=htmlspecialchars(htmlData)%></textarea>
		<br />
		<div class="control">
		<input type="submit" name="sub" onclick="breakout()" value="发送"/><!-- <input type="button" name="btn" value="返回" onclick="goBack()"/>  --><scan style="font-size:10px; margin:0 0 0 100px;">(提交快捷键: Ctrl + Enter)</scan></div>
		</form>
</body>
</html>
<%!
